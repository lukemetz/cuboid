# Taken directly from older version of blocks with a modification to keep things still running
# This is kept here mainly for speed. The new pickling took a very long time.
